    ...
    return(
        <Header style={{height:"min-content"}}>
            <Flex vertical align="center">
                ...
                <Paragraph className="roboto-slab para" style={{marginBottom:"1rem", textAlign:"center",maxWidth:"45ch"}}>How many paragraphs of revolutionary thought do you need?</Paragraph>
